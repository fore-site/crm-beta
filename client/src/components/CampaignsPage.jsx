...
export default function CampaignsPage({ allContacts = [], onOpenAnalytics }) {
    ...
    const [library] = useState([
        {
            id: 1,
            name: 'Q1 Welcome Offer',
            status: 'Active',
            channel: 'Email',
            spend: '$1,200',
            start: '2025-01-05',
            end: '2025-01-12',
            subject: 'Welcome to Q1 Savings',
            bodyEmail: 'Hi [Contact Name], welcome!',
            bodySms: 'Welcome offer inside.',
        },
        {
            id: 2,
            ...
            bodyEmail: 'Important service update',
            bodySms: 'Service update: please read.',
        },
        {
            id: 3,
            name: 'Holiday Promo',
            ...
            bodyEmail: 'Our holiday deals are live!',
            bodySms: 'Holiday deals inside.',
        },
    ]);
                    ...
                    <div className="space-y-2">
                        {filteredLibrary.map((c) => (
                            <div
                                ...
                                className="p-3 rounded-lg border border-gray-200 hover:shadow-md cursor-pointer bg-white"
                            >
