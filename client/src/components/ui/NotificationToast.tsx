...
const BG_COLORS: Record<NotificationType, string> = {
    success: 'bg-green-50 dark:bg-slate-800 border-green-400 dark:border-green-600',
    error: 'bg-red-50 dark:bg-slate-800 border-red-400 dark:border-red-600',
    info: 'bg-blue-50 dark:bg-slate-800 border-blue-400 dark:border-blue-600',
};
...
const NotificationToast: React.FC<NotificationToastProps> = ({ notification, onDismiss }) => {
  ...
  return (
    <div className={`flex items-start p-4 w-full bg-white rounded-lg shadow-lg border-l-4 animate-slide-in ${BG_COLORS[notification.type]}`}>
      ...
      <div className="ml-4 flex-shrink-0 flex">
        <button onClick={onDismiss} className="inline-flex text-slate-400 hover:text-slate-500 dark:text-slate-300 dark:hover:text-white">
