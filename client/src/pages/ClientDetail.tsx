...
const ClientDetailPage: React.FC<ClientDetailProps> = ({
    client,
    _,
    onEdit,
}) => {
            ...
            <Card className="p-6 sm:p-8">
                <div className="flex flex-col sm:flex-row items-start sm:items-center">
                    <img
                        ...
                        alt={client.name}
                        className="w-24 h-24 rounded-full mb-4 sm:mb-0 sm:mr-8 border-4 border-slate-200 dark:border-slate-700"
                    />
