...
export default function App() {
        ...
        return (
            <div className="flex items-center justify-center min-h-screen bg-gray-900 text-white">
                <p className="text-xl animate-pulse">
                    Crafting a beautiful experience...
                </p>
            </div>
        );
    }
    ...
    return (
        <div className="flex flex-col md:flex-row min-h-screen font-sans antialiased bg-gray-100 text-gray-800">
            {/* Sidebar */}
            <aside
            ...
            >
                <div className="flex items-center justify-between mb-12">
                    <div className="text-3xl font-extrabold text-blue-500 tracking-wider">
                        <span className="font-light text-white">CRM</span>.
                    </div>
                    <button
...
const Dashboard = ({ clients, campaigns }) => {
    ...
    const CampaignItem = ({ campaign }) => (
        <li className="flex items-center justify-between p-6 bg-gray-50 rounded-2xl border border-gray-200">
            ...
            <span
                className={`px-4 py-2 text-xs font-bold rounded-full uppercase tracking-wider ${
            ...
            <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-200">
                ...
                {recentCampaigns.length > 0 ? (
                    ...
                    <p className="text-gray-500 text-lg">
                        No recent campaigns. Start creating one!
                    </p>
                )}
            </div>
        </div>
        ...
        <li className="flex flex-col sm:flex-row sm:items-center justify-between p-6 bg-gray-50 rounded-2xl border border-gray-200">
            ...
            <div className="flex space-x-2 mt-4 sm:mt-0">
                <button
                    ...
                    className="px-4 py-2 text-sm rounded-lg font-semibold text-blue-600 bg-blue-100 hover:bg-blue-200 transition-colors"
                >
                    Edit
                </button>
                <button
            ...
            <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-200">
                ...
                <form onSubmit={handleFormSubmit} className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                        <button
                            type="submit"
                            className="flex-1 bg-blue-600 text-white p-4 rounded-xl font-semibold hover:bg-blue-700 transition-colors shadow-md"
                        >
                        ...
                        {editingClientId && (
                            <button
                                type="button"
                                onClick={resetForm}
                                className="flex-1 bg-gray-400 text-white p-4 rounded-xl font-semibold hover:bg-gray-500 transition-colors"
                            >
                                Cancel
                            </button>
                        )}
                ...
                <form onSubmit={handleCreateCampaign} className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                        <button
                            ...
                            className="flex-1 bg-gray-500 text-white p-4 rounded-xl font-semibold hover:bg-gray-600 transition-colors shadow-md"
                        >
                            Show Previews
                        </button>
                        <button
                    ...
                    {editingCampaignId && (
                        <button
                            type="button"
                            onClick={resetForm}
                            className="w-full mt-4 bg-gray-400 text-white p-4 rounded-xl font-semibold hover:bg-gray-500 transition-colors"
                        >
                            Cancel
                        </button>
                    )}
